     ...
     if (current_wpm > 1) {
         ...
         switch (get_highest_layer(layer_state)) {
             case 0:
                 ...
                 break;
             case 1:
                 oled_write_ln_P(PSTR("CDH"), false);
                 break;
             case 2:
 ...
 #    ifdef LUNA
         render_luna(0, 13);
 #    endif
     } else if (is_oled_on() && timer_elapsed32(anim_sleep) > OLED_TIMEOUT) {
         oled_off();
     }
 }
 ...
 bool oled_task_user(void) {
     ...
     } else if (current_wpm > 75) {
         rgb_matrix_sethsv(HSV_YELLOW);
     } else if (current_wpm > 55) {
         rgb_matrix_sethsv(HSV_PURPLE);
     } else if (current_wpm > 35) {
         rgb_matrix_sethsv(HSV_MAGENTA);
     } else if (current_wpm > 23) {
